package com.ferdian.core.data.source.local

import com.ferdian.core.data.source.local.entity.UserEntity
import com.ferdian.core.data.source.local.room.UserDao
